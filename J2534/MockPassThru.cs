...
{
    public class MockPassThru : IPassThru
    {
        /// <summary>
        /// No-op in this case.
        /// </summary>
        ...
        {
            bool dllExists = System.IO.File.Exists(System.IO.Path.Combine(Environment.CurrentDirectory, "J2534Mock.dll"));
            bool pdbExists = System.IO.File.Exists(System.IO.Path.Combine(Environment.CurrentDirectory, "J2534Mock.pdb"));
            Console.WriteLine("Dll exists: " + dllExists);
            Console.WriteLine("Pdb exists: " + pdbExists);
            return (PassThruStatus)NativeMock.PassThruOpen(pName, out pDeviceId);
        }
        ...
        {
            return (PassThruStatus)NativeMock.PassThruClose(DeviceId);
        }
        ...
        {
            return (PassThruStatus)NativeMock.PassThruDisconnect(ChannelID);
        }
        ...
        public PassThruStatus PassThruReadMsgs(
            ...
            UInt32 Timeout)
        {
            return (PassThruStatus)NativeMock.PassThruReadMsgs(ChannelID, pMsg, ref pNumMsgs, Timeout);
        }
        ...
        /// </summary>
        /// <param name="ChannelID">Channel identifier returned from PassThruConnect</param>
        /// <param name="pMsg">Pointer to message structure</param>
        ...
        {
            UInt32 numMsgs = 1;
            return (PassThruStatus)NativeMock.PassThruWriteMsg(ChannelID, pMsg, ref numMsgs, Timeout);
        }
        ...
        public PassThruStatus PassThruWriteMsgs(
            ...
            UInt32 Timeout)
        {
            return (PassThruStatus)NativeMock.PassThruWriteMsgs(ChannelID, pMsg, ref pNumMsgs, Timeout);
        }
        ...
        public PassThruStatus PassThruStopPeriodicMsg(
            ...
            UInt32 MessageID)
        {
            return (PassThruStatus)NativeMock.PassThruStopPeriodicMsg(ChannelID, MessageID);
        }
        ...
        public PassThruStatus PassThruStopMsgFilter(
            ...
            UInt32 FilterID)
        {
            return (PassThruStatus)NativeMock.PassThruStopMsgFilter(ChannelID, FilterID);
        }
        ...
        {
            return (PassThruStatus)NativeMock.PassThruReadVersion(
                DeviceID,
