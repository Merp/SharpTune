...
{
	[System.Serializable]
	public sealed class MafTabImpl : JPanel, MafTab
	{
		private const long serialVersionUID = -6978027421649432740L;

		private readonly LoggerChartPanel chartPanel = new LoggerChartPanel("MAF (v)", "Total Correction (%)"
			);

		private readonly MafControlPanel controlPanel;

		public MafTabImpl(DataRegistrationBroker broker, ECUEditor ecuEditor) : base(new 
			BorderLayout(2, 2))
		{
