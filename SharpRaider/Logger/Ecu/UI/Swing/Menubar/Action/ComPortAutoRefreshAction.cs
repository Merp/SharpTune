...
{
	public sealed class ComPortAutoRefreshAction : AbstractAction
	{
		public ComPortAutoRefreshAction(EcuLogger logger) : base(logger)
		{
		}
		...
		public override void ActionPerformed(ActionEvent actionEvent)
		{
			try
			{
				logger.SetRefreshMode((bool)GetValue(SELECTED_KEY));
			}
			catch (Exception e)
			{
