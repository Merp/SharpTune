...
{
	public sealed class FastPollModeAction : AbstractAction
	{
		public FastPollModeAction(EcuLogger logger) : base(logger)
		{
		}
		...
		public override void ActionPerformed(ActionEvent actionEvent)
		{
			try
			{
				logger.GetSettings().SetFastPoll((bool)GetValue(SELECTED_KEY));
			}
			catch (Exception e)
			{
