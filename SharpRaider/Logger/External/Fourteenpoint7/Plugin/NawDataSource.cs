...
{
	public sealed class NawDataSource : ExternalDataSource
	{
		private NawDataItem dataItem = new NawDataItem(SensorConversionsLambda.LAMBDA, SensorConversionsLambda
