...
using RomRaider.Logger.External.Innovate.Generic.Serial.Plugin;
using RomRaider.Util;
using Sharpen;

namespace RomRaider.Logger.External.Innovate.Generic.Serial.Plugin
{
	public sealed class InnovateDataSource : ExternalDataSource
	{
		private InnovateDataItem dataItem = new InnovateDataItem(SensorConversionsAFR.AFR_147
			, SensorConversionsAFR.LAMBDA, SensorConversionsAFR.AFR_90, SensorConversionsAFR
