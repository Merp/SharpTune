...
namespace RomRaider.Ramtune.Test.IO
{
	public sealed class RamTuneTestAppConnectionProperties : ConnectionProperties
	{
		private readonly ConnectionProperties defaultConnectionProperties;

		private readonly int sendTimeout;

		public RamTuneTestAppConnectionProperties(ConnectionProperties defaultConnectionProperties
			, int sendTimeout)
		{
